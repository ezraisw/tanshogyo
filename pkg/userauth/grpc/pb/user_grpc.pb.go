...
func (c *userServiceClient) Authenticate(ctx context.Context, in *AuthenticationRequest, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
type UserServiceServer interface {
	Authenticate(context.Context, *AuthenticationRequest) (*User, error)
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tanshogyo.v1.UserService",
